    ...
    getClass: function (config) {
        ...
        MODx.Ajax.request({
            ...
            listeners: {
                success: {
                    fn: function (r) {
                        Ext.getCmp(config.id + 'dbadmin-table-package').setValue(r.object.package || '');
                        Ext.getCmp(config.id + 'dbadmin-table-class').setValue(r.object.class || '');
                    }, scope: this
                },
                failure: {
                    fn: function (r) {
